...
<section id="instructors" class="row">
    <div class="col-sm-12">
        <div class="section-header text-center">
            <h2>Leadership</h2>
            <h4>Preaching a living Christ to a dying world</h4>
        </div>
    </div>
        ...
        <div class="speaker">
            <div class="speaker-info">
                  <div class="speaker-photo">
                    <img src="/images/sgrsr.png" alt="Stephen Reynolds, Sr. :: Senior Pastor" >
                </div>
    ...
    <div class="col-md-6 col-sm-6">
        <div class="speaker">
            <div class="speaker-info">
                ...
                <div class="speaker-contacts">
                    <a href="https://www.facebook.com/sreynoldsjr" class="contact pull-right fa fa-facebook"></a>
                </div>
                <div class="speaker-contacts">
                    <a href="mailto:sgrjr@deliverance.me?subject=RE: Deliverance Center" class="contact center fa fa-envelope-o"></a>
                </div>
                <div class="speaker-photo">
...
<section id="partners" class="row">
    ...
    <div class="col-xs-3 col-xsoffset-2">
...
<section id="trips" class="row">
    <div class="col-sm-12">
        <div class="section-header text-left">
            <h2>Missions</h2>
            <h4>From the Streets of Portland, Maine to Africa</h4>
        </div>
    </div>
    <div class="col-md-7 col-sm-12">
        <div class="video">
            <div class="fluid-width-video-wrapper" style="padding-top: 56.25%;">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/lagbfvk_w5M" frameborder="0" allowfullscreen></iframe>
            </div>
        </div>
    </div>
    <div class="col-md-5 col-sm-12">
        <h3>The Gospel is for All</h3>
...
<section id="faq" class="row">
    <div class="col-sm-12">
        <div class="section-header text-left">
            ...
            <h4>Here's a little about what we believe.</h4>
        </div>
    </div>
      ...
      <div class="col-sm-6">
        <ul id="accordion" class="accordion-group">
            @for ($i = 0; $i < 10; $i++)
            <li class="accordion">
             	<a data-toggle="collapse"  class="accordion-heading" data-parent="#accordion" href="#collapse{{$i}}">
                    <h4 class="accordion-title">{{ $t[$i]['title'] }}</h4>
     ...
     <div class="col-sm-6">
        <ul id="accordion2" class="accordion-group">
            @for ($i = 10; $i < count($t); $i++)
            <li class="accordion">
             	<a data-toggle="collapse"  class="accordion-heading" data-parent="#accordion2" href="#collapse{{$i}}">
                    <h4 class="accordion-title">{{ $t[$i]['title'] }}</h4>
                    <span class="fa fa-plus-circle pull-right"></span>
                </a>
                <div id="collapse{{$i}}" class="panel-collapse collapse">
...
<a href="#"><div id="gotop" class="gotop fa fa-arrow-up"></div></a>
