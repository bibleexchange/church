...
@section('content')
	...
	<div class="row" id="admin">
		...
		<nav class="col-sm-3" >
			...
			<ul class="nav">
				<li{{ (Request::is('admin') ? ' class="active"' : '') }}><a href="{{{ URL::to('admin') }}}"><span class="fa fa-home"></span> Admin</a></li>
				<li{{ (Request::is('admin/lessons*') ? ' class="active"' : '') }}><a href="{{{ URL::to('admin/lessons') }}}"><span class="fa fa-list-alt"></span> Lessons</a></li>
				...
				<li class="{{ (Request::is('admin/transcripts*') ? ' active' : '') }}">
					<a href="{{{ URL::to('admin/transcripts') }}}">
						<span class="fa fa-user"></span> Transcripts
					</a>
				...
				<li class="dropdown{{ (Request::is('admin/plans*|admin/users*') ? ' active' : '') }}">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#">
						<span class="fa fa-user"></span> Resources <span class="caret"></span>
					</a>
					<ul class="dropdown-menu">
						<li{{ (Request::is('admin/plans*') ? ' class="active"' : '') }}><a href="{{{ URL::to('admin/plans') }}}"><span class="fa fa-user"></span> Plans</a></li>
						<li{{ (Request::is('admin/roles*') ? ' class="active"' : '') }}><a href="{{{ URL::to('admin/roles') }}}"><span class="fa fa-user"></span> ##</a></li>
					</ul>
				</li>
