...
class Study extends Model {
	...
	{
		return $this->hasMany('\App\Bible\Entities\Task');
	}
	
	public function questions()
	{
		return $this->hasManyThrough('\App\Bible\Entities\Question','\App\Bible\Entities\Task');
	}
	...
	{
		return $this->morphMany('\App\Bible\Entities\TaskProperty','taskable');
	}

	public function text()
	{
		return $this->belongsTo('\App\Bible\Entities\Text','latest_text_id')->first();
	}
	
	public function group()
	{
		return $this->belongsTo('\App\Bible\Entities\UrlNamespace','namespace_id');
	}
	
	public function sections()
	{
		return $this->belongsToMany('\App\Bible\Entities\Section')->orderBy('orderBy','ASC')->orderBy('created_at','ASC');
	}
	...
	{
		return $this->belongsTo('\App\Bible\Entities\BibleVerse','main_verse');
	}
	...
	*/
	...
	{
		return $this->belongsToMany('\App\Bible\Entities\Recording','recording_study','study_id','recording_id');
	}
	
	public function audios()
	{
		return new \App\Bible\Entities\Recording;
	}
	...
	public function creator(){
		return $this->belongsTo('\App\Bible\Entities\User','user_id');
	}
	...
	{
		return \App\Bible\Entities\Revision::editorsFromArray($this->revisions()->get());
	}
	...
	{
		return $this->belongsTo('\App\Bible\Entities\Image','image_id');
	}
	...
	{
		return \App\Bible\Entities\Revision::where('study_id',$this->id);
	}
	
	public function revision()
	{
		return \App\Bible\Entities\Revision::where('text_id', $this->latest_text_id)->where('study_id',$this->id)->first();
	}
