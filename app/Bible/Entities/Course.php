...
class Course extends \Eloquent implements PresentableInterface {
 ...
 public function sections()
    {
        return $this->hasMany('\App\Bible\Entities\Section', 'course_id')->orderBy('orderBy','ASC');
    }
	...
	*/
    ...
    {
    	return $this->belongsTo('\App\Bible\Entities\User');
    }
    
    public function editors()
    {
    	return $this->belongsToMany('\App\Bible\Entities\User', 'course_user', 'course_id', 'user_id');
    }	
