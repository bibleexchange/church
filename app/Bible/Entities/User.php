...
use App\Bible\Core\FollowableTrait;
...
class User extends \Eloquent implements AuthenticatableContract, CanResetPasswordContract {
    ...
    {
        return $this->hasMany('\App\Bible\Entities\Note')->latest();
    }
    ...
    {
    	return $this->belongsToMany('\App\Bible\Entities\Course', 'course_user', 'user_id', 'course_id');
    }
    
	public function courses()
    {
    	return $this->hasMany('\App\Bible\Entities\Course');
    }
	
    public function studies(){
    	
    	return $this->hasMany('\App\Bible\Entities\Study','user_id')->orderBy('updated_at','DESC');
    }
    ...
    public function answers(){
    	...
    	return $this->hasMany('\App\Bible\Entities\Answer','user_id');
    }
    
    public function highlights(){
    
    	return $this->hasMany('\App\Bible\Entities\BibleHighlight','user_id');
    }
    ...
    {
        return $this->belongsToMany('\App\Bible\Entities\Role');
    }
	
	public function hasRole($role)
    {
       If ($this->belongsToMany('\App\Bible\Entities\Role')->where('name','=',$role)->first()) return true;
    ...
    {
        return $this->hasMany('\App\Bible\Entities\Comment');
    }
	
    public function bookmarks()
    {
    	return $this->hasMany('\App\Bible\Entities\Bookmark');
    }
    ...
    public function passwordReset()
    {
    	...
    	return $this->hasMany('\App\Bible\Entities\PasswordReset')
    ...
    {
    	return $this->hasMany('\App\Bible\Entities\Notification');
    }
    ...
    {
    	return $this->hasMany('\App\Bible\Entities\Amen');
    }
