...
class BibleVerse extends \Eloquent {
	...
	{
	    return $this->belongsTo('\App\Bible\Entities\BibleBook', 'b');
	}
	
	public function notes()
	{
		return $this->hasMany('\App\Bible\Entities\Note','bible_verse_id');
	}
	
	public function crossReferences()
	{
		return $this->hasMany('\App\Bible\Entities\CrossReference','vid');
	}
	
	public function studies()
	{
		return $this->hasMany('\App\Bible\Entities\Study','main_verse');
	}
	
	public function translations()
	{
		return $this->hasMany('\App\Bible\Entities\BibleTranslation','verse_id');
	}
	...
	{
	    return $this->belongsTo('\App\Bible\Entities\BibleChapter', 'bible_chapter_id');
	}
	...
	{
		return $this->hasMany('\App\Bible\Entities\BibleHighlight','bible_verse_id');
	}
	
	public function userHighlight($user)
	{
		return $this->hasMany('\App\Bible\Entities\BibleHighlight','bible_verse_id')->where('user_id', $user->id)->first();
	}
