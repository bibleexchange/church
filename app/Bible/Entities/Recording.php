...
class Recording extends \Eloquent {
	...
	{
		return $this->belongsToMany('\App\Bible\Entities\Person', 'person_recording','recording_id','person_id')->withPivot('role', 'memo');
	}
	
	public function preachers()
	{
		return $this->belongsToMany('\App\Bible\Entities\Person', 'person_recording','recording_id','person_id')->withPivot('role', 'memo')->where('role','preacher');
	}
	...
	public function primaryPerson()
	{
		...
		return new \App\Bible\Entities\Person;
		
	}
	
	public function studies()
	{
		return $this->belongsToMany('\App\Bible\Entities\Study', 'recording_study','recording_id','study_id');
	}
	
	public function verses()
	{
		return $this->belongsToMany('\App\Bible\Entities\BibleVerse', 'recording_verse','recording_id','verse_id');
	}
	
    public function formats()
    {
    	return $this->hasMany('\App\Bible\Entities\RecordingFormat');
    }
