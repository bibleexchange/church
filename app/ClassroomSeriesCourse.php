...
class ClassroomSeriesCourse extends Model implements \App\Interfaces\ModelInterface
{
   use \App\Traits\ManageTableTrait;

	public $fillable = ['title','description','art','user_id','public','series_id'];
    ...
    public function modifySchema($table){
      ...
      $table->foreignId('series_id','cs_id')->references('id')->on('classroom_series')->onDelete('cascade')->onUpdate('cascade');
  ...
  public function getSeed(){
    ...
    return \Config::get('seeds')['courses'];
...
/*
  ...
  protected $presenter = 'App\Presenters\Course';
