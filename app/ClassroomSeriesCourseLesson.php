...
class ClassroomSeriesCourseLesson extends Model implements \App\Interfaces\ModelInterface
{
   use \App\Traits\ManageTableTrait;

    public $fillable = ['title','description','art','public','order_by','course_id','user_id'];
    ...
    public function modifySchema($table){
      ...
      $table->foreignId('course_id','csc_id')->references('id')->on('classroom_series_courses')->onDelete('cascade')->onUpdate('cascade');
  ...
  public function getSeed(){
    ...
    return \Config::get('seeds')['lessons'];
  }
...
protected $table = 'lessons';
  ...
  {
    return $this->hasManyThrough('\App\Statement','\App\Activity');
  }
...
class Study extends Model {
  ...
  protected $presenter = 'App\Presenters\StudyPresenter';
