...
class Recording extends \Eloquent {
	...
	{
		return $this->belongsToMany('\App\Person', 'person_recording','recording_id','person_id')->withPivot('role', 'memo');
	}
	
	public function preachers()
	{
		return $this->belongsToMany('\App\Person', 'person_recording','recording_id','person_id')->withPivot('role', 'memo')->where('role','preacher');
	}
	...
	{
		return $this->belongsToMany('\App\BibleVerse', 'recording_verse','recording_id','verse_id');
	}
