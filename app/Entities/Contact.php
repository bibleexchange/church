...
use Deliverance\Entities\Collection;
...
class Contact extends \Eloquent {
	...
	protected $presenter = 'Deliverance\Presenters\ContactPresenter';
	...
	public function addresses()
	  {
		return $this->belongsToMany('Deliverance\Entities\Address');
	  }
	  
	public function collections()
	  {
		return $this->belongsToMany('Deliverance\Entities\Collection');
	  }
	 ...
	 public function gifts(array $range = null)
    {
    	if ($range === null){
    		...
    		return $this->hasMany('Deliverance\Entities\Gift')->whereBetween('created_at',$range);
    	}
    }
         
	public function audios()
    {
        return $this->hasMany('Deliverance\Entities\Audio', 'contact_id');
    }
...
;
	  	...
	  	public function filter($filter,$paginate)
	{
		...
		$contacts = \Deliverance\Entities\Contact::whereHas('addresses', function($q) use ($addresses)
			{
	...
	public function editUrl(){
		return url('/office/contacts/'.$this->id);
	}
