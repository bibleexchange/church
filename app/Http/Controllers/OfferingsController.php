...
use Deliverance\Entities\Offering;
use Input, Redirect;
...
class OfferingsController extends OfficeController {
	...
	public function index()
	{
		...
		return view('office.offerings.index',compact('allOfferings'));
	...
	public function store()
	{
		...
		return Redirect::to('office/deposit/'.$entry->deposit->id.'#'.$entry->name)->with('message', 'Offering Successfully created!');
	}
