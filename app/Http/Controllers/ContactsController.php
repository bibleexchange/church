...
use Deliverance\Entities\Account;
use Deliverance\Entities\Contact;
use Deliverance\Entities\Address AS Address;
use Deliverance\Entities\Gift;
...
class ContactsController extends Controller {
    ...
    {   	
    	return Redirect::to('/office/contacts/'.Input::get('contact_id').'?range_start='.Input::get('start').'&&range_end='.Input::get('end'));
    }
    ...
    public function show($id)
    {
        ...
        $contact = \Deliverance\Entities\Contact::find($id);
	...
	{
		$resourceName = 'Deliverance\Entities\\' . ucfirst($resource);
