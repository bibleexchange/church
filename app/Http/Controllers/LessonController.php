...
use App\Lesson;
use App\Study;
use App\Helpers\StudyFetcher;
use App\Task;
use App\TaskProperty;
use App\TaskType;
use App\Helpers\UserRepository;
use App\Requests\CreateBEStudyRequest;
use App\Requests\UpdateBEStudyRequest;
use App\Requests\UploadMarkdownRequest;
...
class StudiesController extends Controller {
    ...
    public function studySpace(Request $request, $study,$titleSlug=false)
    {
        ...
        if($currentReference !== null){
            ...
            $chapter = BibleReference::isValidReference($currentReference)->chapter;
...
use App\Requests\CreateLessonRequest;
